      ...
      <div className="py-2">
        ...
        <div className="xl:flex md:block flex items-center space-x-1">
          ...
          <div className="flex justify-center xl:pt-0 md:pt-2 pt-0 items-center space-x-1">
            <button className="group-hover:opacity-100  opacity-0  text-white hover:bg-yellow-500 duration-100 bg-black bg-opacity-60 text-xs font-medium p-2 rounded">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                viewBox="0 0 20 20"
            ...
            <button className="group-hover:opacity-100  opacity-0 text-white hover:bg-yellow-500 duration-100 transition delay-100 bg-black bg-opacity-60 text-xs font-medium p-2 rounded hidden md:block">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                viewBox="0 0 20 20"
