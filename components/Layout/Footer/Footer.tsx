  ...
  return (
    <footer>
      ...
      <div className="mt-10 sm:flex items-center justify-center sm:justify-between bg-yellow-500 py-5 xl:px-24 sm:px-10 px-4">
        <div>
          {/* <img className=" sm:mb-0 mb-6 sm:mx-0 mx-auto" src="images/logo-fy.webp" alt=""> */}
        </div>
            ...
            <ul>
              ...
              <li className=" text-gray-500 mb-4">
                <a href="">
                  ...
                  <span className=" ml-3">Raselkazi@gmail.com</span>
                </a>
              </li>
              <li className=" text-gray-500 mb-4">
                <span className=" inline-block">
      ...
      {/* ---------004-------------- */}
      <div className=" lg:flex items-start items-center justify-center lg:justify-between text-gray-500 border-t py-4 xl:px-24 sm:px-10 px-4">
      ...
      <div>
        ...
        <div x-data="{selected:1}" className=" lg:block hidden">
          <div className="fixed xl:right-10 right-3 bottom-60  m-2 mx-0 overflow-hidden transition-all max-h-0 duration-500 z-10">
            <a
          ...
          <button className="focus:outline-none p-2 duration-300 bg-black bg-opacity-40 rounded-full text-white hover:bg-yellow-500 fixed xl:right-10 right-3 bottom-52 m-2 mx-0 z-10">
            <svg
